...
const Dashboard = () => {
    ...
    const [dashboashData, setDashboardData] = useState(dashboardDummyData);
            ...
            <div className="flex gap-4 my-8">
                ...
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    ...
                    <div className="flex flex-col sm:ml-4 font-medium">
                        ...
                        <p className="text-neutral-400 text-base">{dashboashData.totalBookings}</p>
                    </div>
                </div>
                {/* Total Revenue  */}
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    ...
                    <div className="flex flex-col sm:ml-4 font-medium">
                        <p className="text-blue-500 text-lg">Total RevenueIcon</p>
                        <p className="text-neutral-400 text-base">$ {dashboashData.totalRevenue}</p>
                    </div>
                </div>
            </div>
            {/* Recent Bookings */}
            ...
            <div className="w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll">
                <table className="w-full">
                    <thead className="bg-gray-50">
                        <tr>
                            <th className="py3 px-4 text-gray-800 font-medium">User Name</th>
                            <th className="py3 px-4 text-gray-800 font-medium max-sm:hidden">Room Name</th>
                            <th className="py3 px-4 text-gray-800 font-medium text-center" >Total Amount</th>
                            <th className="py3 px-4 text-gray-800 font-medium text-center">Payment Status</th>
                        </tr>
                    </thead>
                    <tbody className="text-sm">
                        {dashboashData.bookings.map((item, index) => (
                            <tr key={index}>
